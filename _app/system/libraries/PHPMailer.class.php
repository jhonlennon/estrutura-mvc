<?php
	 ...
	 * @access public
	 */
	public function setLanguage($langcode = 'pt-BR', $lang_path = null) {
		...
		$lang_path = __DIR__ . DIRECTORY_SEPARATOR . 'php.mailer' . DIRECTORY_SEPARATOR;
	    }
	    $foundlang = true;
	...
	protected function lang($key) {
		...
		$this->setLanguage('pt-BR'); // set the default language
	    }
	...
	public function html2text($html, $advanced = false) {
	    if ($advanced) {
		require_once dirname(__FILE__) . '/php.mailer/extras/class.html2text.php';
